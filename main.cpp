...
#include "Distribution_Classes.h"
#include "cheb_XS.h"
#include "Result_grid.h"
...
int help(void)
{
    ...
    cout << "#" << endl;
    cout << "# The program should be launched either with the name of the parameters files in argument or without argument." << endl;
